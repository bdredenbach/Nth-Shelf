...
const PanelStructuralGrid = (() => {
  ...
  return {analyzeRGBA,analyzeImage,completeImage,completeNestedImage,completeColumnBankImage,completeOccludedTierImage,completeInsetTripletImage,validPanel};
})();
