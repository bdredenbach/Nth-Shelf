...
const PanelStructuralGrid = (() => {
  ...
  return {analyzeRGBA,analyzeImage,completeImage,completeNestedImage,completeOccludedTierImage,completeInsetTripletImage,validPanel};
})();
