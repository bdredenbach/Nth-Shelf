...
android {
    ...
    buildTypes {
        // Isolated test install: leave stable Nth Shelf and Frame Test32/Test33 data alone.
        getByName("debug") {
            applicationIdSuffix = ".frametest34"
            manifestPlaceholders["appLabel"] = "Nth Shelf Test34"
        }
        release {
